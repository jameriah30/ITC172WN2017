    ...
    <div>
        <table>
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="LastNameValidation" runat="server" ErrorMessage="Last Name is Required" ControlToValidate="LastNameTextBox"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>First Name</td>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:CompareValidator ID="CompareValidator" runat="server" ErrorMessage="Passwords Don't Match" ControlToCompare="PasswordTextBox" ControlToValidate="ConfirmTextBox"></asp:CompareValidator></td>
            </tr>
