...
namespace Assignment7.Controllers
{
    public class PersonnelController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LastName, FirstName, Email, Password, Apartment, Street, City, State, Zip, Homephone, WorkPhone")]PersonLite pl)
        {
            int result = db.usp_Register(pl.LastName, pl.FirstName, pl.Email, pl.Password, pl.Apartment, pl.Street, pl.City, pl.State, pl.Zip, pl.HomePhone, pl.WorkPhone);
            return View();
